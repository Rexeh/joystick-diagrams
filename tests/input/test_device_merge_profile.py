...
def test_merge_device_into_profile_with_same_inputs():
    ...
    assert merged_instance.devices.__len__() == 1
    assert merged_instance.devices[GUID].inputs["buttons"]["BUTTON_1"].command == "First"
...
def test_merge_device_into_profile_with_different_inputs():
    ...
    assert merged_instance.devices.__len__() == 1
    assert merged_instance.devices[GUID].inputs["buttons"].__len__() == 2
    assert merged_instance.devices[GUID].inputs["buttons"]["BUTTON_1"].command == "First"
    assert merged_instance.devices[GUID].inputs["buttons"]["BUTTON_2"].command == "Second"
...
def test_merge_device_into_profile_with_modifier_from_target():
    ...
    assert merged_instance.devices.__len__() == 1
    assert merged_instance.devices[GUID].inputs["buttons"]["BUTTON_1"].command == "First"
    assert merged_instance.devices[GUID].inputs["buttons"]["BUTTON_1"].modifiers.__len__() == 1
    assert merged_instance.devices[GUID].inputs["buttons"]["BUTTON_1"].modifiers[0].command == "Modifier"
    assert merged_instance.devices[GUID].inputs["buttons"]["BUTTON_1"].modifiers[0].modifiers == {"ctrl"}
