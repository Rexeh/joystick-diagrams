...
"""
    ...
    def test_parse_global_actions_file_success(self, parser, sample_global_actions_content):
    ...
    def test_encoding_issues_in_global_actions(self, parser, sample_global_actions_with_encoding_issues):
        """Test that encoding issues are fixed when parsing global.actions"""
        with patch("builtins.open", mock_open(read_data=sample_global_actions_with_encoding_issues)):
            parser._parse_global_actions_file()
    ...
    def test_csv_export_functionality(self, parser, tmp_path):
        ...
        assert "Device;Technical_Name;Description;IL2_Control;Real_Control" in csv_content
        ...
        french_chars_found = any('é' in line or 'à' in line or 'ç' in line for line in lines)
