...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy3.setHeightForWidth(self.parserPluginList.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy4.setHeightForWidth(self.addParserPlugin.sizePolicy().hasHeightForWidth())
